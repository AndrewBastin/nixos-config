/**
 * Vendored from mitsuhiko/agent-stuff, extensions/unified-edit.ts.
 *
 * Upstream: https://github.com/mitsuhiko/agent-stuff/blob/main/extensions/unified-edit.ts
 * Pinned at commit c77d49797ad3fb78888e5b002ae606a93777c6b1 (2026-08-16).
 * License: Apache-2.0 (upstream repo). Vendored verbatim; local edits, if any,
 * are marked with "muru:" comments.
 *
 * Replaces pi's built-in `edit` tool with a unified edit tool that accepts
 * either a row-oriented edit script or a Codex/apply_patch-style patch.
 */
/**
